export const translations = {
  es: {
    ...
    editor: { preview: 'Vista previa', web: 'Web', mobile: 'Mobile', close: 'Cerrar', backToCatalog: 'Volver al catálogo', sections: { background: 'Fondo', card: 'Tarjeta', details: 'Detalles', style: 'Estilo', blocks: 'Bloques' } },
  ...
  en: {
    ...
    editor: { preview: 'Preview', web: 'Web', mobile: 'Mobile', close: 'Close', backToCatalog: 'Back to catalog', sections: { background: 'Background', card: 'Card', details: 'Details', style: 'Style', blocks: 'Blocks' } },
    ...
    home: { badge: 'Unique and unforgettable digital invitations', titleStart: 'Create your wedding invitation in', titleHighlight: 'minutes', subtitle: 'Customize every detail, add incredible extras, and share your link with your guests.', primaryButton: 'Create my invitation', secondaryButton: 'See examples', benefits: { fast: 'Easy and fast', customizable: '100% Customizable', secure: 'Safe and private' }, howTitle: 'How does it work?', steps: { personaliza: { title: 'Customize', description: 'Fill in your event information and choose your favorite style.' }, extras: { title: 'Add extras', description: 'Add features like gallery, map, countdown and more.' }, link: { title: 'Get your link', description: 'Review your invitation and share it with your guests.' } } },
    phone: { label: 'OUR WEDDING', names: 'Maria & Carlos', date: 'June 14, 2027', location: 'Rose Garden Hall', message: 'We would love for you to be part of this special day.', button: 'Confirm attendance' },
  },
};
