...
const buildStylesFromTheme = (theme = {}) => ({
  ...
  heroOverlay: theme.heroOverlay || 'rgba(0,0,0,0.30)',
  heroTextColor: theme.heroTextColor || '#FFFFFF',
  heroAccentColor: theme.heroAccentColor || '#FFFFFF',
  quoteBackground: theme.quoteBackground || (theme.heroBackground || 'linear-gradient(135deg, #4D4A43 0%, #303030 100%)'),
  quoteOverlay: theme.quoteOverlay || 'rgba(0,0,0,0.25)',
  quoteTextColor: theme.quoteTextColor || '#FFFFFF',
